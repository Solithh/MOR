package me.mor.features.gui;

import me.mor.MOR;
import me.mor.features.Feature;
import me.mor.features.gui.items.Item;
import me.mor.features.gui.items.buttons.ModuleButton;
...
public class MORGui extends Screen {
    private static MORGui INSTANCE;
    ...
    public MORGui() {
        super(Component.literal("MOR"));
        setInstance();
        load();
    }

    public static MORGui getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new MORGui();
        }
        return INSTANCE;
    ...
    public static MORGui getClickGui() {
        return MORGui.getInstance();
    }
