package me.mor.features.modules;
...
import me.mor.manager.ConfigManager;
import me.mor.util.traits.Jsonable;
import me.mor.util.traits.Toggleable;
...
public class Module extends Feature implements Jsonable, Toggleable {
    ...
    public void setDisplayName(String name) {
        Module module = MOR.moduleManager.getModuleByDisplayName(name);
        Module originalModule = MOR.moduleManager.getModuleByName(name);
    ...
    public JsonElement toJson() {
        ...
        for (Setting<?> setting : getSettings()) {
            try {
                ...
                MOR.LOGGER.error("Failed to create JSON field", e);
            }
        }
        return object;
    }
    ...
    public void fromJson(JsonElement element) {
        ...
        for (Setting<?> setting : getSettings()) {
            try {
                ...
                MOR.LOGGER.error("Failed to load from JSON", throwable);
            }
        }
    }
