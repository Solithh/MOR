package me.mor.util.render;

import net.minecraft.client.renderer.rendertype.RenderSetup;
import net.minecraft.client.renderer.rendertype.RenderType;

import static me.mor.util.render.Pipelines.GLOBAL_LINES_PIPELINE;
import static me.mor.util.render.Pipelines.GLOBAL_QUADS_PIPELINE;
